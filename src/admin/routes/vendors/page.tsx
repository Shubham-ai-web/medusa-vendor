    ...
    commandHelper.command({
      ...
      action: async (selection: Record<string, boolean>) => {
        ...
        try {
          ...
          refetch();
          setRowSelection({});
          toast.success(`${vendorsToDeleteIds.length} vendor(s) deleted successfully`);
        } catch (error) {
...
const columns = [
  columnHelper.select(),
  columnHelper.accessor("company_name", { header: "Company Name", enableSorting: true }),
  ...
  columnHelper.accessor("country", { header: "Country", enableSorting: true }),
];
...
const VendorsPage = () => {
  ...
  const handleDelete = async () => {
    ...
    refetch();
    toast.success(`Vendor ${selectedVendor.first_name} ${selectedVendor.last_name} deleted successfully`);
    setDeleteOpen(false);
    setSelectedVendor(null);
  };

  const actionColumn = getActionColumn(setSelectedVendor, setEditOpen, setDeleteOpen);
